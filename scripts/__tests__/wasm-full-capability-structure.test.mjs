...
const activePages = [
  ...
  '/sdk/wasm/user/moderating-a-user/block-and-unblock-other-members',
  '/sdk/wasm/user/retrieving-and-updating-user-information/retrieve-the-online-status-of-a-user',
  '/sdk/wasm/user/retrieving-and-updating-user-information/update-user-profile',
  ...
  '/sdk/wasm/message/retrieving-messages/retrieve-message-list',
  '/sdk/wasm/message/retrieving-messages/retrieve-messages',
  '/sdk/wasm/message/searching-messages/search-messages',
  '/sdk/wasm/message/composing-messages/add-extra-data-to-a-message',
  ...
  '/sdk/wasm/message/managing-messages/delete-or-revoke-a-message',
  ...
  '/sdk/wasm/message/managing-read-status/manage-group-message-read-receipts',
