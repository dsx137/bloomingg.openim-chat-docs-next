...
sourcePath: "/docs/chat/platform-api/v3/group/group-moderation/mute-group"
---

使用 **禁言群组** 从可信后端调用 OpenIM 群组 REST 接口。禁言整个群组；群主和管理员通常仍可发言。 请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和管理员 Token；接口参数通过请求头和 JSON 请求体传递。
