---
title: "删除用户发出的入群申请"
description: "OpenIM 商业版 Platform API：删除用户向指定群组发出的入群申请记录。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/group/group-applications/delete-user-group-requests"
---

删除用户向指定群组发出的入群申请记录。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
...
| groupIDs | 是       | string[] | OpenIM 群组 ID 列表。 |
