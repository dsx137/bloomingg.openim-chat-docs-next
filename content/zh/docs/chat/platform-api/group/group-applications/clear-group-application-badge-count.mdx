---
title: "清除入群申请角标数"
description: "OpenIM 商业版 Platform API：清除用户当前的入群申请角标计数。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/group/group-applications/clear-group-application-badge-count"
---

清除用户当前的入群申请角标计数。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
