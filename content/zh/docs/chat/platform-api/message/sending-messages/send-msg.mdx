...
| content | 是 | object | 消息内容对象，结构由 `contentType` 决定。见[消息内容类型](/platform-api/message/message-content-types)。 |
...
- [会话列表](/platform-api/conversation/listing-conversations/get-conversations)
