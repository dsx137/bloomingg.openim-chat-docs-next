---
title: "标记会话已读位置"
description: "OpenIM 商业版 Platform API：按消息 Seq 更新用户在指定会话中的已读位置。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/message/read-status/mark-conversation-read"
---

按消息 Seq 更新用户在指定会话中的已读位置。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
