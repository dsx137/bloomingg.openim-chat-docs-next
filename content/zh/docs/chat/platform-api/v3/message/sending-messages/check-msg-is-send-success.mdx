---
title: "检查消息发送状态"
description: "OpenIM 消息 REST API：检查消息发送状态。"
sourcePath: "/docs/chat/platform-api/v3/message/sending-messages/check-msg-is-send-success"
---

使用 **检查消息发送状态** 从可信后端调用 OpenIM 消息 REST 接口。获取 API 发送消息状态标记。 请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和 Token；接口参数通过请求头和 JSON 请求体传递。
