---
title: "离线推送前"
description: "OpenIM Webhooks：在离线推送前调整实际推送用户和离线推送信息。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/push/before-offline-push"
---

在离线推送前调整实际推送用户和离线推送信息。
...
| -------- | ---------------------------------- |
| 类型     | 前置回调                           |
| 配置项   | `beforeOfflinePush`                |
| 回调命令 | `callbackBeforeOfflinePushCommand` |
