---
title: "群聊在线推送前"
description: "OpenIM Webhooks：在群聊在线推送前调整目标用户或推送策略。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/push/before-group-online-push"
---
...
| -------- | -------------------------------------- |
| 类型     | 前置回调                               |
| 配置项   | `beforeGroupOnlinePush`                |
| 回调命令 | `callbackBeforeGroupOnlinePushCommand` |
