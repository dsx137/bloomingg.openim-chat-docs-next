---
title: "设置好友备注后"
description: "OpenIM Webhooks：在好友备注更新后同步变更。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/relation/after-set-friend-remark"
---
...
| -------- | ------------------------------------- |
| 类型     | 后置回调                              |
| 配置项   | `afterSetFriendRemark`                |
| 回调命令 | `callbackAfterSetFriendRemarkCommand` |
