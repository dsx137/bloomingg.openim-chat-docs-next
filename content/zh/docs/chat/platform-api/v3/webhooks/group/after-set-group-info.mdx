---
title: "设置群资料后"
description: "OpenIM Webhooks：在群资料更新后同步变更。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/group/after-set-group-info"
---
...
| -------- | ---------------------------------- |
| 类型     | 后置回调                           |
| 配置项   | `afterSetGroupInfo`                |
| 回调命令 | `callbackAfterSetGroupInfoCommand` |
