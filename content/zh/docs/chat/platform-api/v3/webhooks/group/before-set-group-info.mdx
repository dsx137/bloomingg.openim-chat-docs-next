---
title: "设置群资料前"
description: "OpenIM Webhooks：在设置群资料前校验或调整字段。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/group/before-set-group-info"
---
...
| -------- | ----------------------------------- |
| 类型     | 前置回调                            |
| 配置项   | `beforeSetGroupInfo`                |
| 回调命令 | `callbackBeforeSetGroupInfoCommand` |
