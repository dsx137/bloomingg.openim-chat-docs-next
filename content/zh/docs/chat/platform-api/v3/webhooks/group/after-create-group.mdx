---
title: "创建群组后"
description: "OpenIM Webhooks：在群组创建完成后同步群资料和初始成员。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/group/after-create-group"
---
...
| -------- | --------------------------------- |
| 类型     | 后置回调                          |
| 配置项   | `afterCreateGroup`                |
| 回调命令 | `callbackAfterCreateGroupCommand` |
