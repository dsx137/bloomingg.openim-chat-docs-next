---
title: "按字段设置群资料前"
description: "OpenIM Webhooks：在按字段设置群资料前校验或调整本次变更。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/group/before-set-group-info-ex"
---
...
| -------- | ------------------------------------- |
| 类型     | 前置回调                              |
| 配置项   | `beforeSetGroupInfoEx`                |
| 回调命令 | `callbackBeforeSetGroupInfoExCommand` |
