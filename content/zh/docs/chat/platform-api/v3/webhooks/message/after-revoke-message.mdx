---
title: "消息撤回后"
description: "OpenIM Webhooks：在消息撤回完成后同步撤回事件。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/message/after-revoke-message"
---
...
| 类型     | 后置回调                        |
| 配置项   | `afterRevokeMsg`                |
| 回调命令 | `callbackBeforeAfterMsgCommand` |
