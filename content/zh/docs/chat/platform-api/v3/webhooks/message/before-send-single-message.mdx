---
title: "发送单聊消息前"
description: "OpenIM Webhooks：在单聊消息发送前执行内容审核、拦截或字段检查。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/message/before-send-single-message"
---

在单聊消息发送前执行内容审核、拦截或字段检查。
...
| -------- | ------------------------------------ |
| 类型     | 前置回调                             |
| 配置项   | `beforeSendSingleMsg`                |
| 回调命令 | `callbackBeforeSendSingleMsgCommand` |
