---
title: "更新用户资料后"
description: "OpenIM Webhooks：在用户资料更新完成后同步变更。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/user/after-update-user-info"
---
...
| -------- | ------------------------------------ |
| 类型     | 后置回调                             |
| 配置项   | `afterUpdateUserInfo`                |
| 回调命令 | `callbackAfterUpdateUserInfoCommand` |
