---
title: "设置主持人"
description: "OpenIM 商业版 Platform API：设置会议主持人和联合主持人。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/meeting/meeting-settings/set-meeting-host"
---

设置会议主持人和联合主持人。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
...
```bash
curl --request POST "${API_ADDRESS}/rtc-meeting/set_meeting_host_info" \
...
| hostUserID    | 否       | StringValue | 会议主持人用户 ID。      |
| coHostUserIDs | 是       | string[]    | 联合主持人用户 ID 列表。 |
