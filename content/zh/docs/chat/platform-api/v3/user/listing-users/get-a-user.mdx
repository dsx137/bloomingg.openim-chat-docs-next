...
| statuses <span className="enterprise-field-badge">商业版</span> | 选填 | int[] | 只返回符合指定账号状态的用户，元素参见[用户模块的 `UserStatus`](/docs/chat/platform-api/v3/user/overview#userstatus)。 |
...
| usersInfo | array  | [用户模块的 `UserInfo`](/docs/chat/platform-api/v3/user/overview#userinfo) 列表 |
