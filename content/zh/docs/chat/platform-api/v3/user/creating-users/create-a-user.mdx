...
sourcePath: "/docs/chat/platform-api/v3/user/creating-users/create-a-user"
---

使用 **创建用户** 从可信后端调用 OpenIM REST 接口。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和管理员 Token；接口参数通过请求头和 JSON 请求体传递。
