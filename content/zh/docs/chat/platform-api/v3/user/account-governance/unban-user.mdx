---
title: "解除用户封禁"
description: "OpenIM 商业版 Platform API：解除指定用户的封禁状态。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/user/account-governance/unban-user"
---

解除指定用户的封禁状态。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
