---
title: "注销用户"
description: "OpenIM 商业版 Platform API：批量注销不再使用服务的用户账号。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/user/account-governance/unregister-user"
---

批量注销不再使用服务的用户账号。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
