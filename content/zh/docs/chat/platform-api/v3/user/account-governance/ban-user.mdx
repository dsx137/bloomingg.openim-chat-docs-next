---
title: "封禁用户"
description: "OpenIM 商业版 Platform API：封禁指定用户，阻止账号继续使用商业版服务。"
...
version: "v3"
edition: "enterprise"
sourcePath: "/docs/chat/platform-api/v3/user/account-governance/ban-user"
---

封禁指定用户，阻止账号继续使用商业版服务。 此接口仅在 OpenIM 商业版中提供。请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和有效 Token。
