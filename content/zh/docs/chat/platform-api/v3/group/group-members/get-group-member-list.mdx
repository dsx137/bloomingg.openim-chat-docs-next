...
sourcePath: "/docs/chat/platform-api/v3/group/group-members/get-group-member-list"
---
...
| data.members | array | 群成员资料列表，结构为[群组模块的 `GroupMemberInfo`](/docs/chat/platform-api/v3/group/overview#groupmemberinfo)。 |
