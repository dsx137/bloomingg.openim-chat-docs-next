...
sourcePath: "/docs/chat/platform-api/v3/group/group-applications/join-group"
---
...
| joinSource | 是 | int | 入群来源，参见[群组模块的 `JoinSource`](/docs/chat/platform-api/v3/group/overview#joinsource)。 |
