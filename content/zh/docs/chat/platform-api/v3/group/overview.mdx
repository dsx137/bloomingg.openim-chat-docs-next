...
- [更新群组信息](/docs/chat/platform-api/v3/group/managing-groups/set-group-info-ex)
...
- [更新群成员信息](/docs/chat/platform-api/v3/group/group-members/set-group-member-info)
...
- [获取入群申请角标](/docs/chat/platform-api/v3/group/group-applications/get-group-application-badge-count) <span className="enterprise-field-badge">商业版</span>
