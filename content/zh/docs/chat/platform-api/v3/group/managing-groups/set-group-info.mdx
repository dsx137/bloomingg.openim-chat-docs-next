---
title: "设置群组信息"
description: "OpenIM 群组 REST API：设置群组信息。"
sourcePath: "/docs/chat/platform-api/v3/group/managing-groups/set-group-info"
---

使用 **设置群组信息** 从可信后端调用 OpenIM 群组 REST 接口。使用嵌套的 `groupInfoForSet` 对象修改群资料。 请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和管理员 Token；接口参数通过请求头和 JSON 请求体传递。
