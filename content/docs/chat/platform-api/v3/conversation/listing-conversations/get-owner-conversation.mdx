...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/conversation/listing-conversations/get-owner-conversation"
---

Get owner conversation is an OpenIM conversation REST API for trusted backend services. Configure the API address and administrator token in [Prepare to use the API](/docs/chat/platform-api/v3/prepare-to-use-api) before calling management endpoints.
