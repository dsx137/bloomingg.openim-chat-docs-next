...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/group/managing-groups/transfer-group-owner"
---

Transfer group owner is an OpenIM group REST API for trusted backend services. Configure the API address and administrator token in [Prepare to use the API](/docs/chat/platform-api/v3/prepare-to-use-api) before calling management endpoints.
...
| oldOwnerUserID | Yes | string | The old owner user id value. |
| newOwnerUserID | Yes | string | The new owner user id value. |
