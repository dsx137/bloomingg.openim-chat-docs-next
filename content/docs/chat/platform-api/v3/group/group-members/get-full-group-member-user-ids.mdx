---
title: "全量获取群成员用户 ID"
description: "OpenIM 群组 REST API：全量获取群成员用户 ID。"
...
使用 **全量获取群成员用户 ID** 从可信后端调用 OpenIM 群组 REST 接口。按哈希比较并全量获取指定群组的成员用户 ID 列表。 请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和管理员 Token；接口参数通过请求头和 JSON 请求体传递。
