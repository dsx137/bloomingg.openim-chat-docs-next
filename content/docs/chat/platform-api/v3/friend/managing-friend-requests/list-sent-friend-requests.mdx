---
title: "查询发出的好友申请"
description: "OpenIM 好友 REST API：查询发出的好友申请。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/friend/managing-friend-requests/list-sent-friend-requests"
---

使用 **查询发出的好友申请** 从可信后端调用 OpenIM 好友 REST 接口。分页查询指定用户主动发出的好友申请。 请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和管理员 Token；接口参数通过请求头和 JSON 请求体传递。
