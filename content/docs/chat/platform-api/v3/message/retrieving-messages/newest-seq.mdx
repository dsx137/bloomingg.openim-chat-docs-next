---
title: "获取最新序列号"
description: "OpenIM 消息 REST API：获取最新序列号。"
...
使用 **获取最新序列号** 从可信后端调用 OpenIM 消息 REST 接口。获取指定用户相关会话的最大消息 Seq 和最小消息 Seq。 请先在[接入准备](/docs/chat/platform-api/v3/prepare-to-use-api)中配置 API 地址和 Token；接口参数通过请求头和 JSON 请求体传递。
