...
OpenIM Platform API 面向可信后端服务，提供用户、群组、消息、上传、Webhook 和运营管理相关的 REST 接口参考。本文档集对应 OpenIM Server `v3.8.3-patch.16`。中文文档保留 Platform API 的导航方式，具体能力、接口路径和请求字段以 OpenIM REST 已覆盖的文档为准。
