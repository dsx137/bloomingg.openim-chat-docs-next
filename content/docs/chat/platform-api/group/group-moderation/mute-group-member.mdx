...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/group/group-moderation/mute-group-member"
---

Mute group member is an OpenIM group REST API for trusted backend services. Configure the API address and administrator token in [Prepare to use the API](/docs/chat/platform-api/v3/prepare-to-use-api) before calling management endpoints.
...
| mutedSeconds | Yes | int | The muted seconds value. |
